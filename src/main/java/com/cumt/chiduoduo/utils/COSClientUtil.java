 ...
 * @date ：Created in 2019/3/1 15:50
 * @description：用户上传评论图片工具类
 * @modified By：
 * @version: 1$
 */
public class COSClientUtil {
    ...
    // 存储通名称			替换成自己的
    private static final String bucketName = "chiduoduo123-1257644994";
    //secretId 			替换成自己的
    private static final String secretId = "AKIDGH24qMGfRxA8uQQgSzGK9l7D5h3CstQi";
    // secretKey		        替换成自己的
    private static final String secretKey = "Bj383GEzVnrgGajcJkwta2EEyWqwoRpy";
